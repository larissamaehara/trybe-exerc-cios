...
# Para verificar se a requisição foi bem sucedida,
# faça (assert "User-Agent value doesn't look like a standard mozilla/chrome/safari value" not in response.text).
