...
export default class Student extends Person {
  ...
  //Método que checa se a inscrição da pessoa estudante possui no mínimo 16 caracteres
  ...
  //Método que gera um id de inscrição aleatório baseado na data de cadastro da pessoa estudante
