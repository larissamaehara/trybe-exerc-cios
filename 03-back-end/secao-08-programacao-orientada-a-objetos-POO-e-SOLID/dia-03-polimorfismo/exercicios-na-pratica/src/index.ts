...
Com sua quadra adicionada ao clube, você já pode reservar essa quadra na data que você quiser. 
Chame o método reservar da classe QuadraFutebol, 
...
const reservarQuadraFutebol = trybeClube
  ...
  console.log(reservarQuadraFutebol); // imprimindo o resultado da reserva da quadra